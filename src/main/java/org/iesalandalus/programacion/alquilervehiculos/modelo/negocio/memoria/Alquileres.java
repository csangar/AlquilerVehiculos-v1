...
public class Alquileres implements IAlquileres {
	...
	private Alquiler getAlquilerAbierto(Cliente cliente) {
		...
		while(iterador.hasNext() && alquilerAbierto == null) {
			Alquiler comodin = iterador.next();
			if(comodin.getCliente().equals(cliente) && comodin.getFechaDevolucion() == null) {
				alquilerAbierto = comodin;
			}
		}
	...
	private Alquiler getAlquilerAbierto(Vehiculo vehiculo) {
		...
		while(iterador.hasNext() && alquilerAbierto == null) {
			Alquiler comodin = iterador.next();
			if(comodin.getVehiculo().equals(vehiculo) && comodin.getFechaDevolucion() == null) {
				alquilerAbierto = comodin;
			}
		}
		return alquilerAbierto;
